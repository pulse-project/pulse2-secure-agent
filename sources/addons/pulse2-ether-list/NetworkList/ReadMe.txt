========================================================================
    APPLICATION CONSOLE&nbsp;: Vue d'ensemble du projet NetworkList
========================================================================

AppWizard a cr&eacute;&eacute; cette application NetworkList pour vous.

Ce fichier contient un r&eacute;sum&eacute; des &eacute;l&eacute;ments contenus dans chaque fichier qui
constitue votre application NetworkList.
...
StdAfx.h, StdAfx.cpp
    ...
    nomm&eacute; NetworkList.pch et un fichier de types pr&eacute;compil&eacute;s nomm&eacute; StdAfx.obj.
